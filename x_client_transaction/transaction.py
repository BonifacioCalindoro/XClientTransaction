...
class AsyncClientTransaction:
    ...
    async def get_transaction_id(self, home_page_response: Union[bs4.BeautifulSoup, httpx.Response]):
        self.home_page_response = self.validate_response(home_page_response)
    ...
    async def get_indices(self, home_page_response=None):
        ...
        if on_demand_file:
            ...
            async with httpx.AsyncClient() as client:
                on_demand_file_response = await client.get(on_demand_file_url)
